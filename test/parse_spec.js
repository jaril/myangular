...
describe("parse", function() {
  ...
  it("can parse a floating number", function() {
    var fn = parse('4.2');
    expect(fn()).toBe(4.2);
  });
  ...
  it("uses locals instead of scopes when there is a matching key", function() {
    var fn = parse('aKey');
    var scope = {aKey: 42};
    var locals = {aKey: 43};
  ...
  it("does not use locals when there is a matching key", function() {
    var fn = parse('aKey');
    var scope = {aKey: 42};
