...
describe("Scope", function() {
  ...
  /* RIP very first MyAngular test 06/18 - 08/18 */
  ...
  describe("digest", function() {
    ...
    it("allows async $apply with $applyAsync", function(done) {
      ...
      scope.$digest();
      expect(scope.counter).toBe(1); //1 change > 2 watch count + 1 listen count
    ...
    it("does not include the $$postDigest in the digest", function() {
  ...
  describe("$watchGroup", function() {
    ...
    it('does not call the zero-watch listener when deregistered first', function() {
      ...
      destroyGroup(); //sets shouldCall to false, doesn't let a second call run the listener
  ...
  describe("inheritance", function() {
    ...
    it("digests from root on $evalAsync when isolated", function(done) {
      var child = parent.$new(true);
      var child2 = child.$new();
  ...
  describe("$watchCollection", function() {
    ...
    it("notices an item replaced in a node list object", function() {
  ...
  describe("Events", function() {
    ...
    it("allow registering listeners", function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it("does not skip the next listener when removed on " + method, function() {
        ...
        //meant to deregister itself upon calling
    ...
    it("propagates the same event event up on $emit", function() {
      var parentListener = jasmine.createSpy();
      var scopeListener = jasmine.createSpy();
    ...
    it("propagates the same event event up on $broadcast", function() {
      var childListener = jasmine.createSpy();
      var scopeListener = jasmine.createSpy();
    ...
    it("attaches target scope on $", function() {
