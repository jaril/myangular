...
describe('bootstrap', function() {
  ...
  describe('manual', function() {
    ...
    beforeEach(function() {
      //jasmine creates a new window for each it() call?
      //either that or it does an async call at a point where the window is wipe
      //less likely since window.jaril persists
    ...
    it('is available', function() {
      console.log('check me out' + window.jaril);
