...
describe('filter', function() {
  ...
  beforeEach(function() {
    publishExternalAPI(); //replace register/filter with the new module
  });
  ...
  it('allows registering multiple filter functions', function() {
    var myFilter = function() { };
  ...
  it('is available through the injector', function() {
    var myFilter = function() { };
    var injector = createInjector(['ng', function($filterProvider) {
